...
export default function ButtonAppBar() {
    const { handleChange, handleSubmit, suggestions ,meals} = CustomContext();
        ...
        <Box sx={{ flexGrow: 1 }} className="navBar">
            <AppBar position="fixed" >
                <Toolbar className='navBar1'>
                    ...
                    {/* <Search onChange={handleChange} sx={{}}>
                        <SearchIconWrapper>
                            <SearchIcon />
                    ...
                    <Autocomplete
                        ...
                        style={{ width: 500 , fontFamily: "cursive" }}
                        renderInput={(params) => (
                    ...
                    {/* <ColorButton variant="contained" type="submit" className='btn-1' onClick={handleSubmit}>Search</ColorButton> */}
